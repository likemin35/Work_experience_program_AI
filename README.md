...
## 2026-04-07 Update (Expected KPI-aware strategy)
...
### What changed
- Added expected KPI fields in history records:
  - `expected_participation_rate`
  - `expected_conversion_rate`
  - `expected_click_through_rate`
- Strategy mode now uses expected vs actual KPI gap:
  - above expected -> `reuse`
  - below expected -> `new`
  - similar to expected -> `hybrid`
- Agent now returns deterministic reason/references from KPI comparison.
